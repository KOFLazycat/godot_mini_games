...
class ExampleAdvance:
	...
	var some_map_1: Dictionary[String, float]
	## 道具Id
...
class TbExampleAdvance:
	var _data_list: Array[ExampleAdvance]
...
class CfgTables:
	var tbExampleBasic: TbExampleBasic
	var tbExampleAdvance: TbExampleAdvance
	var tbExampleSingleton: TbExampleSingleton
	
	func _init(loader: Callable) -> void:
		self.tbExampleBasic = TbExampleBasic.new(loader.call('tbexamplebasic'))
		self.tbExampleAdvance = TbExampleAdvance.new(loader.call('tbexampleadvance'))
		self.tbExampleSingleton = TbExampleSingleton.new(loader.call('tbexamplesingleton'))
