...
const Example_Ability_Fireball_Shoot: StringName = &"Example.Ability.Fireball.Shoot"
...
const Example_Cue_Vfx_Fireball_Impact: StringName = &"Example.Cue.Vfx.Fireball.Impact"
...
const State_Debuff_Poision: StringName = &"State.Debuff.Poision"
