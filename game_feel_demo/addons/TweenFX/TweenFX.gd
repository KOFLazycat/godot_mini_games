...
const ANIMATION_TYPES: Dictionary = {
	TweenFXAnimations.POP_IN:            AnimationType.ONE_SHOT,
	TweenFXAnimations.POP_OUT:           AnimationType.ONE_SHOT,
	TweenFXAnimations.PUNCH_IN:          AnimationType.ONE_SHOT,
	TweenFXAnimations.PUNCH_OUT:         AnimationType.ONE_SHOT,
	TweenFXAnimations.FADE_IN:           AnimationType.ONE_SHOT,
	TweenFXAnimations.FADE_OUT:          AnimationType.ONE_SHOT,
	TweenFXAnimations.DROP_IN:           AnimationType.ONE_SHOT,
	TweenFXAnimations.DROP_OUT:          AnimationType.ONE_SHOT,
	TweenFXAnimations.JUMP_SCARE:        AnimationType.ONE_SHOT,
	TweenFXAnimations.SPIN:              AnimationType.ONE_SHOT,
	TweenFXAnimations.SKEW:              AnimationType.ONE_SHOT,
	TweenFXAnimations.VANISH:            AnimationType.ONE_SHOT,
	TweenFXAnimations.SHAKE:             AnimationType.ONE_SHOT,
	TweenFXAnimations.PULSATE:           AnimationType.ONE_SHOT,
	TweenFXAnimations.JITTER:            AnimationType.ONE_SHOT,
	TweenFXAnimations.JELLY:             AnimationType.ONE_SHOT,
	TweenFXAnimations.FLIP:              AnimationType.ONE_SHOT,
	TweenFXAnimations.HOP:               AnimationType.ONE_SHOT,
	TweenFXAnimations.BLINK:             AnimationType.ONE_SHOT,
	TweenFXAnimations.SQUASH:            AnimationType.ONE_SHOT,
	TweenFXAnimations.STRETCH:           AnimationType.ONE_SHOT,
	TweenFXAnimations.SNAP:              AnimationType.ONE_SHOT,
	TweenFXAnimations.CHARGE_UP:         AnimationType.ONE_SHOT,
	TweenFXAnimations.RICOCHET:          AnimationType.ONE_SHOT,
	TweenFXAnimations.GLITCH:            AnimationType.ONE_SHOT,
	TweenFXAnimations.SPOTLIGHT:         AnimationType.ONE_SHOT,
	TweenFXAnimations.TWIST:             AnimationType.ONE_SHOT,
	TweenFXAnimations.EXPLODE:           AnimationType.ONE_SHOT,
	TweenFXAnimations.BLACK_HOLE:        AnimationType.ONE_SHOT,
	TweenFXAnimations.TV_SHUTDOWN:       AnimationType.ONE_SHOT,
	TweenFXAnimations.CREEP_OUT:         AnimationType.ONE_SHOT,
	TweenFXAnimations.RUBBER_BAND:       AnimationType.ONE_SHOT,
	TweenFXAnimations.FIDGET:            AnimationType.ONE_SHOT,
	TweenFXAnimations.DEFLATE:           AnimationType.ONE_SHOT,
	TweenFXAnimations.DRUNK:             AnimationType.ONE_SHOT,
	TweenFXAnimations.IMPACT_LAND:       AnimationType.ONE_SHOT,
	TweenFXAnimations.CRITICAL_HIT:      AnimationType.ONE_SHOT,
	TweenFXAnimations.UPGRADE:           AnimationType.ONE_SHOT,
	TweenFXAnimations.FOLD_IN:           AnimationType.ONE_SHOT,
	TweenFXAnimations.FOLD_OUT:          AnimationType.ONE_SHOT,
	TweenFXAnimations.POINT:             AnimationType.ONE_SHOT,
	TweenFXAnimations.TADA:              AnimationType.ONE_SHOT,
	TweenFXAnimations.PRESS:             AnimationType.ONE_SHOT,
	TweenFXAnimations.PRESS_ROTATE:      AnimationType.ONE_SHOT,
	TweenFXAnimations.MAGNETIC_PULL:     AnimationType.ONE_SHOT,
	TweenFXAnimations.HEADSHAKE:         AnimationType.ONE_SHOT,

	TweenFXAnimations.COLOR_CYCLE:       AnimationType.LOOPING,
	TweenFXAnimations.HEARTBEAT:         AnimationType.LOOPING,
	TweenFXAnimations.SWING:             AnimationType.LOOPING,
	TweenFXAnimations.WAVE_DISTORT:      AnimationType.LOOPING,
	TweenFXAnimations.WIGGLE:            AnimationType.LOOPING,
	TweenFXAnimations.FLOAT_BOB:         AnimationType.LOOPING,
	TweenFXAnimations.GLOW_PULSE:        AnimationType.LOOPING,
	TweenFXAnimations.ROTATE_HOP:        AnimationType.LOOPING,
	TweenFXAnimations.SPIN_BOUNCE:       AnimationType.LOOPING,
	TweenFXAnimations.MAD_HELICO:        AnimationType.LOOPING,
	TweenFXAnimations.MELT:              AnimationType.LOOPING,
	TweenFXAnimations.IDLE_RUBBER:       AnimationType.LOOPING,
	TweenFXAnimations.BUBBLE_ASCEND:     AnimationType.LOOPING,
	TweenFXAnimations.BREATHE:           AnimationType.LOOPING,
	TweenFXAnimations.SWAY:              AnimationType.LOOPING,
	TweenFXAnimations.FLICKER:           AnimationType.LOOPING,
	TweenFXAnimations.ALARM:             AnimationType.LOOPING,
	TweenFXAnimations.GHOST:             AnimationType.LOOPING,
	TweenFXAnimations.ATTRACT:           AnimationType.LOOPING,
	TweenFXAnimations.ORBIT:             AnimationType.LOOPING,
}

const ANIMATION_REQUIREMENTS: Dictionary = {
	TweenFXAnimations.WAVE_DISTORT: NodeRequirement.NODE_2D,
	TweenFXAnimations.SKEW:         NodeRequirement.NODE_2D,
}
#endregion

#region LOGIC
## Stops a specific animation running on the node.
func stop(node: CanvasItem, anim: TweenFXAnimations) -> void:
...
func is_playing(node: CanvasItem, anim: TweenFXAnimations) -> bool:
	return TweenManager.is_playing(node, anim)

## Returns true if the animation loops indefinitely until stopped.
func is_looping_type(anim: TweenFXAnimations) -> bool:
...
func requires_node2d(anim: TweenFXAnimations) -> bool:
...
func color_cycle(node: CanvasItem, duration: float = 3.0, saturation: float = 1.0, value: float = 1.0) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.COLOR_CYCLE)
...
func swing(node: CanvasItem, duration: float = 1.0, angle: float = 30.0) -> Tween:
	...
	TweenManager.track(node, TweenFXAnimations.SWING, tween)
	return tween
...
func wave_distort(node: Node2D, duration: float = 1.0, amplitude: float = 0.1) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.WAVE_DISTORT)
	var original_scale: Vector2 = node.scale
	var tween := node.create_tween()
	tween.set_loops()
	tween.set_ease(Tween.EASE_IN_OUT)
	...
	TweenManager.track(node, TweenFXAnimations.WAVE_DISTORT, tween)
	return tween

## Slightly rotates the node back and forth.
func wiggle(node: CanvasItem, duration: float = 1.2) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.WIGGLE)
	var tween := node.create_tween()
	tween.set_loops()
	...
	TweenManager.track(node, TweenFXAnimations.WIGGLE, tween)
	return tween
...
func float_bob(node: CanvasItem, duration: float = 2.0, height: float = 5.0) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.FLOAT_BOB)
	...
	tween.tween_property(node, "position:y", original_pos.y + height, duration * 0.5).set_trans(Tween.TRANS_SINE).set_ease(Tween.EASE_IN_OUT)
	TweenManager.track(node, TweenFXAnimations.FLOAT_BOB, tween)
	return tween
...
func glow_pulse(node: CanvasItem, duration: float = 1.2, scale_amt: float = 0.05, alpha_amt: float = 0.3) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.GLOW_PULSE)
	var original_scale: Vector2 = node.scale
	...
	TweenManager.track(node, TweenFXAnimations.GLOW_PULSE, tween)
	return tween
...
func rotate_hop(node: CanvasItem, duration: float = 0.4, angle: float = 15.0, height: float = 10.0) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.ROTATE_HOP)
	...
	TweenManager.track(node, TweenFXAnimations.ROTATE_HOP, tween)
	return tween
...
func spin_bounce(node: CanvasItem, duration: float = 0.6, bounce_scale: float = 0.2, spin_speed: float = 180.0) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.SPIN_BOUNCE)
	var original_scale: Vector2 = node.scale
	var tween := node.create_tween()
	tween.set_loops()
	...
	TweenManager.track(node, TweenFXAnimations.SPIN_BOUNCE, tween)
	return tween
...
func mad_helico(node: CanvasItem, duration: float = 0.6, spin_speed: float = 1080.0, bob_height: float = 5.0) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.MAD_HELICO)
	var original_pos: Vector2 = node.position
	var tween := node.create_tween()
	tween.set_loops()
	tween.parallel().tween_property(node, "rotation_degrees", node.rotation_degrees + spin_speed, duration).set_trans(Tween.TRANS_LINEAR)
	...
	TweenManager.track(node, TweenFXAnimations.MAD_HELICO, tween)
	return tween
...
func melt(node: CanvasItem, duration: float = 2.0, melt_distance: float = 20.0) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.MELT)
	var original_pos: Vector2 = node.position
	var original_scale: Vector2 = node.scale
	var tween := node.create_tween()
	tween.set_loops()
...
func bubble_ascend(node: CanvasItem, duration: float = 2.0, height: float = 15.0) -> Tween:
	...
	TweenManager.track(node, TweenFXAnimations.BUBBLE_ASCEND, tween)
	return tween
...
func breathe(node: CanvasItem, duration: float = 3.0, strength: float = 0.1) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.BREATHE)
	var original_scale: Vector2 = node.scale
	var tween := node.create_tween()
	tween.set_loops()
...
func attract(node: CanvasItem, duration: float = 1.2, strength: float = 0.12) -> Tween:
	...
	TweenManager.track(node, TweenFXAnimations.ATTRACT, tween)
	return tween
...
func orbit(node: CanvasItem, duration: float = 2.0, radius: float = 30.0, start_angle: float = 0.0) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.ORBIT)
	var original_pos: Vector2 = node.position
	var tween := node.create_tween()
	tween.set_loops()
	var steps = 60
...
func sway(node: CanvasItem, duration: float = 2.0, angle: float = 8.0) -> Tween:
	...
	TweenManager.track(node, TweenFXAnimations.SWAY, tween)
	return tween
...
func flicker(node: CanvasItem, duration: float = 0.08, min_alpha: float = 0.4, steps: int = 8) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.FLICKER)
	var original_alpha: float = node.modulate.a
	var tween := node.create_tween()
	tween.set_loops()
...
func alarm(node: CanvasItem, duration: float = 0.3, color : Color = Color(2.0, 0.2, 0.2, 1.0)) -> Tween:
	...
	TweenManager.track(node, TweenFXAnimations.ALARM, tween)
	return tween
	#endregion
...
func creep_out(node: CanvasItem, duration: float = 1.0) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.CREEP_OUT)
	var original_scale: Vector2 = node.scale
	var tween := node.create_tween()
	...
	TweenManager.track(node, TweenFXAnimations.CREEP_OUT, tween)
	return tween
...
func tv_shutdown(node: CanvasItem, duration: float = 0.5, original_scale: Vector2 = Vector2.ONE) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.TV_SHUTDOWN)
	var tween := node.create_tween()
	...
	TweenManager.track(node, TweenFXAnimations.TV_SHUTDOWN, tween)
	return tween

## Spins and collapses into nothingness.
func black_hole(node: CanvasItem, duration: float = 0.8) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.BLACK_HOLE)
	var tween := node.create_tween()
	...
	TweenManager.track(node, TweenFXAnimations.BLACK_HOLE, tween)
	return tween

## Boom!
func explode(node: CanvasItem, duration: float = 0.4, scale_amt: float = 1.8) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.EXPLODE)
	var tween := node.create_tween()
	...
	TweenManager.track(node, TweenFXAnimations.EXPLODE, tween)
	return tween

## Builds up energy visually before a release.
func charge_up(node: CanvasItem, duration: float = 1.0) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.CHARGE_UP)
	var original_scale: Vector2 = node.scale
	var original_color: Color = node.modulate
	var tween := node.create_tween()
...
func punch_out(node: CanvasItem, duration: float = 0.5, min_scale: float = 0.5) -> Tween:
	...
	TweenManager.track(node, TweenFXAnimations.PUNCH_OUT, tween)
	return tween
...
func ricochet(node: CanvasItem, duration: float = 0.8, strength: float = 30.0, bounces: int = 4) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.RICOCHET)
	var original_pos: Vector2 = node.position
	var tween := node.create_tween()
	...
	TweenManager.track(node, TweenFXAnimations.RICOCHET, tween)
	return tween
...
func glitch(node: CanvasItem, duration: float = 1.0, intensity: float = 10.0, frames: int = 12) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.GLITCH)
	var original_pos: Vector2 = node.position
	var original_color: Color = node.modulate
	var tween := node.create_tween()
...
func jump_scare(node: CanvasItem, duration: float = 0.4, intensity: float = 1.3) -> Tween:
	...
	TweenManager.track(node, TweenFXAnimations.JUMP_SCARE, tween)
	return tween
...
func spotlight(node: CanvasItem, duration: float = 1.0, glow: Color = Color(1.5, 1.5, 1.5, 1.0), state: PlayState = PlayState.FULL, use_self_modulate : bool = false) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.SPOTLIGHT)
...
func flip(node: CanvasItem, duration: float = 0.4, axis: String = "x", flips: int = 1) -> Tween:
	...
	TweenManager.track(node, TweenFXAnimations.FLIP, tween)
	return tween
...
func hop(node: CanvasItem, duration: float = 0.4, height: float = 20.0, direction: Vector2 = Vector2.UP) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.HOP)
	var original_pos: Vector2 = node.position
	...
	TweenManager.track(node, TweenFXAnimations.HOP, tween)
	return tween
...
func squash(node: CanvasItem, duration: float = 0.2, amount: float = 0.3, horizontal: bool = true) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.SQUASH)
	var original_scale: Vector2 = node.scale
	...
	TweenManager.track(node, TweenFXAnimations.SQUASH, tween)
	return tween
...
func stretch(node: CanvasItem, duration: float = 0.2, amount: float = 0.3) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.STRETCH)
	var original_scale: Vector2 = node.scale
	var tween := node.create_tween()
	...
	tween.tween_property(node, "scale", original_scale, duration * 0.5).set_trans(Tween.TRANS_SINE)
	TweenManager.track(node, TweenFXAnimations.STRETCH, tween)
	return tween
...
func snap(node: CanvasItem, duration: float = 0.1, scale: Vector2 = Vector2(1.3, 1.3), state: PlayState = PlayState.FULL) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.SNAP)
	var original_scale: Vector2 = node.scale
	var tween := node.create_tween()
	match state:
		PlayState.ENTER:
	...
	TweenManager.track(node, TweenFXAnimations.SNAP, tween)
	return tween
...
func pulsate(node: CanvasItem, duration: float = 0.5, scale_factor: float = 1.2) -> Tween:
	...
	tween.tween_property(node, "scale", original_scale, duration * 0.5).set_trans(Tween.TRANS_SINE).set_ease(Tween.EASE_IN_OUT)
	TweenManager.track(node, TweenFXAnimations.PULSATE, tween)
	return tween
...
func jitter(node: CanvasItem, duration: float = 0.5, amount: float = 5.0, times: int = 8) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.JITTER)
	...
	TweenManager.track(node, TweenFXAnimations.JITTER, tween)
	return tween
...
func jelly(node: CanvasItem, duration: float = 0.6, amount: float = 0.3, cycles: int = 2) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.JELLY)
	var original_scale: Vector2 = node.scale
	var tween := node.create_tween()
	for i in range(cycles):
		...
		tween.tween_property(node, "scale", original_scale * Vector2(1.0 - amount, 1.0 + amount), duration * 0.25 / cycles).set_trans(Tween.TRANS_SINE).set_ease(Tween.EASE_IN_OUT)
	tween.tween_property(node, "scale", original_scale, duration * 0.2).set_trans(Tween.TRANS_ELASTIC).set_ease(Tween.EASE_OUT)
	TweenManager.track(node, TweenFXAnimations.JELLY, tween)
	return tween
...
func spin(node: CanvasItem, duration: float = 0.5, revolutions: float = 1.0, clockwise: bool = true) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.SPIN)
	var original_rotation : float = node.rotation_degrees
...
func pop_in(node: CanvasItem, duration: float = 0.3, overshoot: float = 0.1) -> Tween:
	...
	TweenManager.track(node, TweenFXAnimations.POP_IN, tween)
	return tween
...
func pop_out(node: CanvasItem, duration: float = 0.3, overshoot: float = 0.1) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.POP_OUT)
	var original_scale: Vector2 = node.scale
	var tween := node.create_tween()
	...
	TweenManager.track(node, TweenFXAnimations.POP_OUT, tween)
	return tween
...
func skew(node: Node2D, duration: float = 0.3, skew_x: float = 0.5, skew_y: float = 0.5) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.SKEW)
	var original_scale: Vector2 = node.scale
	...
	TweenManager.track(node, TweenFXAnimations.SKEW, tween)
	return tween

## Fades out and scales down the node.
func vanish(node: CanvasItem, duration: float = 0.4) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.VANISH)
	var tween := node.create_tween()
	...
	TweenManager.track(node, TweenFXAnimations.VANISH, tween)
	return tween
...
func punch_in(node: CanvasItem, duration: float = 0.15, strength: float = 0.3) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.PUNCH_IN)
	var original_scale: Vector2 = node.scale
	var tween := node.create_tween()
	...
	TweenManager.track(node, TweenFXAnimations.PUNCH_IN, tween)
	return tween
...
func shake(node: CanvasItem, duration: float = 0.3, amount: float = 10.0, shakes: int = 5, axis: Vector2 = Vector2.ONE) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.SHAKE)
	var original_pos: Vector2 = node.position
	var tween := node.create_tween()
	...
	TweenManager.track(node, TweenFXAnimations.SHAKE, tween)
	return tween
...
func drop_in(node: CanvasItem, duration: float = 0.5, drop_height: float = 100.0, scale_distort: Vector2 = Vector2(1.2, 0.8)) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.DROP_IN)
	var original_pos: Vector2 = node.position
	var original_scale: Vector2 = node.scale
	var original_alpha: float = node.modulate.a
...
func drop_out(node: CanvasItem, duration: float = 0.5, drop_height: float = 100.0) -> Tween:
	...
	TweenManager.track(node, TweenFXAnimations.DROP_OUT, tween)
	return tween
...
func rubber_band(node: CanvasItem, duration: float = 0.5, strength: float = 0.4) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.RUBBER_BAND)
	var original_scale: Vector2 = node.scale
	var tween := node.create_tween()
	...
	TweenManager.track(node, TweenFXAnimations.RUBBER_BAND, tween)
	return tween
...
func fidget(node: CanvasItem, duration: float = 0.8, spins: int = 6) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.FIDGET)
	var original_rotation : float = node.rotation_degrees
	var tween := node.create_tween()
...
func impact_land(node: CanvasItem, duration: float = 0.5) -> Tween:
	...
	TweenManager.track(node, TweenFXAnimations.IMPACT_LAND, tween)
	return tween
...
func critical_hit(node: CanvasItem, duration: float = 0.5, color: Color = Color(2.0, 0.3, 0.3, 1.0), scale_amount: float = 1.6) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.CRITICAL_HIT)
	var original_scale: Vector2 = node.scale
	var original_color: Color = node.modulate
	...
	TweenManager.track(node, TweenFXAnimations.CRITICAL_HIT, tween)
	return tween
...
func upgrade(node: CanvasItem, duration: float = 0.8, glow: Color = Color(2.0, 1.8, 0.2, 1.0), scale_amount: float = 1.5) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.UPGRADE)
	var original_scale: Vector2 = node.scale
	var original_color: Color = node.modulate
...
func point(node: CanvasItem, duration: float = 0.5, direction: Vector2 = Vector2.RIGHT, amount: float = 24.0) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.POINT)
	var original_pos: Vector2 = node.position
	var tween := node.create_tween()
...
func tada(node: CanvasItem, duration: float = 0.6) -> Tween:
	...
	tween.tween_property(node, "scale", original_scale, duration * 0.3).set_trans(Tween.TRANS_ELASTIC).set_ease(Tween.EASE_OUT)
	TweenManager.track(node, TweenFXAnimations.TADA, tween)
	return tween
...
func press(node: CanvasItem, duration: float = 0.3, squash: float = 0.8, overshoot: float = 1.1) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.PRESS)
	var original_scale: Vector2 = node.scale
	var tween := node.create_tween()
	...
	TweenManager.track(node, TweenFXAnimations.PRESS, tween)
	return tween
...
func press_rotate(node: CanvasItem, duration: float = 0.3, squash: float = 0.85, angle: float = 5.0) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.PRESS_ROTATE)
	var original_scale: Vector2 = node.scale
	...
	TweenManager.track(node, TweenFXAnimations.PRESS_ROTATE, tween)
	return tween
...
func magnetic_pull(node: CanvasItem, duration: float = 0.5, target: Vector2 = Vector2.ZERO, strength: float = 0.4) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.MAGNETIC_PULL)
	var original_pos: Vector2 = node.position
	...
	TweenManager.track(node, TweenFXAnimations.MAGNETIC_PULL, tween)
	return tween
...
func headshake(node: CanvasItem, duration: float = 0.5, amount: float = 8.0, times: int = 3) -> Tween:
	TweenManager.stop(node, TweenFXAnimations.HEADSHAKE)
	var original_rotation : float = node.rotation_degrees
	var tween := node.create_tween()
	for i in range(times):
	...
	TweenManager.track(node, TweenFXAnimations.HEADSHAKE, tween)
	return tween
	#endregion
